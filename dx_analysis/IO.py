...
def config_parser(config_file,parameters):	# Function to take config file and create/fill the parameter dictionary 
    ...
    """
    necessary_parameters = ['output_directory','visualization_functions_file','visualization_pdb','pdb_list','selection','dx_output_file_name']

    all_parameters = ['output_directory','visualization_functions_file','visualization_pdb','pdb_list','selection','dx_output_file_name','summary_boolean','dx_delta']
